...
static void BOARD_InitGPIOPins(void);
...
app_ver_t g_sAppIdFM = {
    "../../../examples/lpcxpresso55s69/demo_apps/mc_pmsm/pmsm_snsless/cm33_core0",     /* User Path 1- the highest priority */
    "",       /* User Path 2 */
    "lpcxpresso55s69",    /* board id */
