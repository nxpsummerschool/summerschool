...
- pin_list:
  ...
  - {pin_num: '60', peripheral: SYSCON, signal: CLKOUT, pin_signal: PIO0_26/FC2_RXD_SDA_MOSI_DATA/CLKOUT/CT_INP14/SCT0_OUT5/USB0_IDVALUE/FC0_SCK/HS_SPI_MOSI/SECURE_GPIO0_26,
    mode: inactive, slew_rate: standard, invert: disabled, open_drain: disabled}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port0_pin26_config = (/* Pin is configured as CLKOUT */
                                         IOCON_PIO_FUNC2 |
    ...
    /* PORT0 PIN26 (coords: 60) is configured as CLKOUT */
