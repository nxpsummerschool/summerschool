...
1. Blinky LED for Red and Blue lights of the RGB LED
...
2. Blinky LEDs with different blink rates
   Adapt the code such that we the two LEDs blink with different rates.

3. Read button and implement debounce
...
4. Finite state machine with different blink rates based on 5 states
